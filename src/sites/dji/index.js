...
export const djiAdapter = {
  id: 'dji',
  opencliSite: SITE,
  name: 'DJI',
  description: 'DJI social and intern recruitment',
  ...
  async all(args = {}) {
    ...
    assertNonEmpty(rows, 'dji all', 'Try fewer filters or inspect filters with `job dji filters`.');
    return rows;
  },
};

export default djiAdapter;
