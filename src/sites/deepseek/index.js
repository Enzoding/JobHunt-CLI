...
export const deepseekAdapter = {
  ...
  async search(args = {}) {
    ...
    assertNonEmpty(rows, 'deepseek search', 'Try a different keyword or inspect filters with `job deepseek filters`.');
    return rows;
  },
  ...
  async all(args = {}) {
    ...
    assertNonEmpty(rows, 'deepseek all', 'Try fewer filters or inspect filters with `job deepseek filters`.');
    return rows;
  },
};
